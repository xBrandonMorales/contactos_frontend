document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch(`https://8000-xbrandonmor-contactosfr-srymps5rnj7.ws-us106.gitpod.io${encodeURIComponent(email)}`)
        ...
        .catch(error => console.error(" Hubo un error al obtener detalles del contacto:", error));
});
