document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch(`https://8080-xbrandonmor-contactosba-865ied0q764.ws-us106.gitpod.io/${encodeURIComponent(email)}`)
        .then(response => {
            if (!response.ok) {
...
function borrarContacto() {
    ...
    fetch(`https://8000-xbrandonmor-contactosba-865ied0q764.ws-us106.gitpod.io/${encodeURIComponent(email)}`, {
        method: 'DELETE',
        headers: {
